...
if (global.autobio) {
  supreme.updateProfileStatus(`BOLEN MD 𝙱𝙾𝚃 is Online✅ | |Runtime ${runtime(process.uptime())}`)
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━//
    case 'gitclone': {
		      ...
		      if (!text) return m.reply(`provide  a github link.\n *Example:* .gitclone https://github.com/SB-043/BOLEN-MD`)
...
await m.reply("Successfully left the group by BOLEN MD\nMessage : _Supreme Adios..._")
await sleep(2000)
