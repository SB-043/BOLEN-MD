...
async function startconn() {
    ...
    if (pairingCode && !conn.authState.creds.registered) {
        ...
        if (!pn('+' + phoneNumber).isValid()) {
            console.log(chalk.red('Invalid phone number. Please enter your full international number (e.g., 255743379497 for Tanzania, 254769772273 for Kenya, etc.) without + or spaces.'));
            process.exit(1);
        }
...
┗❐═⭔════════⭔═❐`,
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            ...
                            newsletterName: 'Bolen 𝐌ᴅ',
                            serverMessageId: -1
                        }
                    }
                });
                console.log(color('>Bolen Md is Connected< [ ! ]','red'));
            }
        } catch (err) {
